...
/// <summary>
/// Точка входа в веб-приложение сервиса библиотеки.
/// </summary>
[UsedImplicitly]
public class Program
{
    ...
    /// <summary>
    /// Запускает веб-приложение сервиса библиотеки.
    /// </summary>
    ...
    /// <summary>
    /// Создает и запускает ASP.NET Core приложение сервиса библиотеки.
    /// </summary>
    /// <param name="args">Аргументы командной строки.</param>
    [UsedImplicitly]
